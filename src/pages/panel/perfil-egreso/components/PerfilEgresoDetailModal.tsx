...
import { formatDate, getEstadoBadgeVariant } from "../perfil-egreso.utils";
import type { PerfilEgresoEnriched } from "../perfil-egreso.types";

interface PerfilEgresoDetailModalProps {
  open: boolean;
...
export function PerfilEgresoDetailModal({
  open,
  record,
  onClose,
}: PerfilEgresoDetailModalProps) {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title="Detalle del perfil de egreso"
...
export default PerfilEgresoDetailModal;
