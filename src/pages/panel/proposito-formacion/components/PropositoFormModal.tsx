...
export function PropositoFormModal({
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title={mode === "create" ? "Crear propósito de formación" : "Editar propósito de formación"}
      description={
        mode === "create"
          ? "Registra un nuevo propósito asociado a una seccional, facultad, programa y plan específico."
          : "En edición solo se modifica el estado y el texto descriptivo, manteniendo la estructura académica original."
      }
      size="lg"
      footer={
    ...
    >
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div className="rounded-[20px] border border-[var(--color-gray-6)] bg-[var(--color-surface-soft)] p-4">
          ...
          <p className="mt-2 text-sm leading-6 text-[var(--color-gray-3)]">
            Cuando el registro ya existe, se bloquean seccional, facultad, programa y plan de estudios.
          </p>
          {record ? (
