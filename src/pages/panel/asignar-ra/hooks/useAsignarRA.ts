...
export function useAsignarRA() {
  ...
  const actions = useAsignarRAActions({
    ...
    courses: filters.courses,
    isCourseAssignmentComplete: computed.isCourseAssignmentComplete,
    selectedCycle: filters.selectedCycle,
  ...
  return {
    ...
    hasNextPendingCourse: actions.hasNextPendingCourse,
    ...
    handleNextCourse: actions.handleNextCourse,
    ...
    handleConfirmMeasuredAssignment: actions.handleConfirmMeasuredAssignment,
    handleCancelMeasuredAssignment: actions.handleCancelMeasuredAssignment,
