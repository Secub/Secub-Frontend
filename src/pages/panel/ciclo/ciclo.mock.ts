...
export const mockCiclos: CicloMedicion[] = [
  {
    id: "ciclo-2024-2025-sis-cali",
    nombre: "Selección de Cursos 2024-2025",
    seccionalId: "cali",
    facultadId: "ing-cali",
    programaId: "sis-cali",
    planId: "sis-cali-2024-2",
    ...
    fechaFin: "2025-07-15",
    estado: "activo",
    cursoIds: ["cur-sis-cali-701", "cur-sis-cali-703"],
    progreso: 10,
    responsableId: "usr-director-001",
    responsableNombre: "Laura Gómez",
    createdAt: "2026-03-20T09:20:00",
    updatedAt: "2026-03-20T09:20:00",
  },
  {
    id: "ciclo-2024-2025-sis-bog",
    nombre: "Selección de Cursos 2024-2025",
    seccionalId: "bogota",
    facultadId: "ing-bog",
    programaId: "sis-bog",
    ...
    fechaFin: "2025-07-15",
    estado: "activo",
    cursoIds: ["cur-sis-bog-701", "cur-sis-bog-703"],
    progreso: 10,
    responsableId: "usr-director-002",
    responsableNombre: "Andrés Rojas",
    createdAt: "2026-03-20T09:20:00",
    updatedAt: "2026-03-20T09:20:00",
  },
  {
    id: "ciclo-2023-2024-multimedia-bog",
    nombre: "Selección de Cursos 2023-2024",
    seccionalId: "bogota",
    facultadId: "ing-bog",
    programaId: "multimedia-bog",
    planId: "multimedia-bog-2024-2",
    ...
    fechaFin: "2024-12-31",
    estado: "finalizado",
    cursoIds: ["cur-mul-bog-801"],
    progreso: 100,
    responsableId: "usr-director-003",
    responsableNombre: "Paula Ríos",
    createdAt: "2025-01-20T09:20:00",
