...
interface MapeoCompetenciasExportModalProps {
  open: boolean;
  title: string;
  format: "pdf" | "excel";
...
export function MapeoCompetenciasExportModal({
  open,
  title,
  format,
  permissions,
  ...
  initialFilters,
  onClose,
}: MapeoCompetenciasExportModalProps) {
...
export default MapeoCompetenciasExportModal;
