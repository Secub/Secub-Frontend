...
}: NucleoSemestreCardProps) 
{
  ...
  return (
    <article
      id={semestreNumero === 1 ? "mapeo-nucleos-semestre-1" : undefined}
      className="w-full overflow-hidden rounded-lg border-2 border-[var(--color-gray-5)] bg-[var(--secub-surface)] shadow-sm transition-shadow hover:shadow-md"
    >
