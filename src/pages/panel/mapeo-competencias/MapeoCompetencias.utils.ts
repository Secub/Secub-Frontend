...
export function enrichMapeoCompetencias(
  ...
  return records.map((record) => {
    ...
    const lugar = catalogs.lugares.find(
      (item) => item.id === record.lugarId,
    );
    ...
    const plan = catalogs.planes.find(
...
//   form: FormState,
//   original: MapeoCompetenciasEnriched | null,
//   existingRecords?: MapeoCompetenciasRecord[],
// ): MapeoCompetenciasRecord {
